...
import { AppstoreAddOutlined, SolutionOutlined, UserAddOutlined, UserOutlined } from '@ant-design/icons';
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/admin' || pathname.includes('admin/dashboard')
                }
              >
                {(handleClick, open) => {
                  return (
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            ...
                            >
                              <AppstoreAddOutlined />Add Course
                            </NavLink>
                          </li>
                        </ul>
                      </div>
