...
import { AppstoreAddOutlined, CalendarOutlined, SolutionOutlined, UserAddOutlined, UserOutlined, FolderAddOutlined, UnorderedListOutlined, FileAddOutlined } from '@ant-design/icons';
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              {/* <!-- Menu Item histories transation --> */}
              <li>
                <NavLink
                  to="/admin/histories_transaction"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes("admin/histories_transaction") &&
                    "bg-graydark dark:bg-meta-4"
                    }`}
                >
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/admin/form_course_add" ||
                  pathname.includes("/admin/form_course_add")
                }
              >
                {(handleClick, open) => {
                  return (
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          ...
                          <li>
                            ...
                            >
                            <FileAddOutlined />Thêm mới bài học
                            </NavLink>
                          </li>
                        </ul>
                      </div>
