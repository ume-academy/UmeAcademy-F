...
import { navigationCategory } from '../../../contants/client'
...
export default Header
                            ...
                            {/* <div className="block">
                                <p className='block'>Thái Tuấn</p>
                                <p className='block'>nguyentrungduc2807@gmail.com</p>

                            </div> */}


                    {/* <===== Start khách =====>*/}
                    {/* <Link className='mr-[60px] hover:text-[#FB9C46]' to={``}>Giảng dạy trên UmeAcademy</Link>
                    <Link className='mr-[60px] bg-[#407F55] py-1.5 px-4 rounded-[8px] text-white hover:opacity-95' to={``}>Login</Link>
                    <Link className='bg-[#FB9C46] py-1.5 px-4 rounded-[8px] text-white hover:opacity-95' to={``}>Sign Up</Link> */}
                    {/* End khách */}