        ...
        <div className="flex items-center">
          ...
          <div className="ml-3 ">
            <div className="flex mb-1">
              <Link
                className="inline font-semibold text-[16px] max-w-[180px] truncate"
                to={`/admin`}
              >
                Tuấn Thái
              </Link>
              <div
                className={`${styles["border_teacher"]} text-[10px] flex items-center justify-center ml-3`}
              >
                <span
            ...
            <Link
              to={`/admin`}
              className="block text-[#999999] max-w-[180px] truncate hover:text-[#999999]"
            >
            ...
            <div className="flex items-center min-w-[706px] justify-end font-semibold">
              ...
              >
                <Button className="flex items-center justify-start border-[1px] border-[#C5C5C5] p-2 h-[46px] rounded-[14px] min-w-[180px]">
                  ...
                  <span className="ml-1 font-semibold max-w-[120px] truncate">
                    Tuấn Thái
                  </span>
                  <div
                    className={`${styles["border_teacher"]} text-[10px] flex items-center justify-center`}
                  >
                    <span
                      className={`${styles["backGR_teacher"]} block font-bold rounded-[5px] px-1 py-0.5 bg-[rgba(234, 241, 255, 1)]  text-[#0058FA] hover:text-[#0058FA]`}
                    >
                      Teacher
                    </span>
                  </div>
              ...
              {navigationCategory.map((title) => (
                <ul className="h-[60px] flex items-center" key={title.id}>
                  <li className="">
                    <Link
                      to={`#`}
                      className="text-[20px] font-semibold hover:underline p-4"
                    >
                      {title.title}
                    </Link>
                  </li>
